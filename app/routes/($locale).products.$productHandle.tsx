...
export default function Product() {
  ...
  return (
    <>
      <Section className="">
        <div className="grid items-start  md:grid-cols-2 lg:grid-cols-2">
          <ProductGallery
            media={media.nodes}
...
"
      ...
      <div className=" gap-2 w-5/6 m-auto grid lg:grid-cols-3 sm:grid-cols-1 ">
...
"
              ...
              <p className="">
                Our dedicated support team is available24/7 to help with
            ...
            <div className="flex flex-wrap items-baseline gap-4 ">
              {
                option.optionValues.length > 1 ? (
                  <div className="relative w-full">
                    <h1 className="font-bold pb-2">select variant</h1>
                    <Listbox>
                      {({open}) => (
                        <>
                          <Listbox.Button
